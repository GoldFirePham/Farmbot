...
# Filter points for plants and extract coordinates
plant_name = 'Green Zucchini'
target_plants = [point for point in points if point.get("name") == plant_name]

if len(target_plants) == 0:
	print("No" + plant_name + " plants found.")
	exit(0)
...
for y, row in sorted_rows:
	...
	for x, y, z in row:
		...
		print(f"Moving to {plant_name} plant at coordinates: x={x}, y={y}, z={z}")
...
print("Finished moving to all " + plant_name + "plants.")
